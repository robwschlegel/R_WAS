...
[Thesisdown](https://github.com/ismayc/thesisdown) is built from [Bookdown](https://bookdown.org/home/). It is a very useful tool to start working from if your goal is to submit your thesis using the language R Markdown. It allows you to jump into a working template and coustomize the content. The [Thesisdown](https://github.com/ismayc/thesisdown) package was created by [\@Old_Man_Chester](https://twitter.com/old_man_chester) and the introduction to the package which can be found [here]() is copied below
